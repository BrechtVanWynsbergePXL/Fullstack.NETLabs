...
namespace DevOps.Domain.Tests
{
    public class DeveloperTests : TestBase
    {
        ...
        [Test]
        public void CreateNew_NoRating_ShouldThrowContractException()
        {
            Assert.That(() => Developer.CreateNew(_id, _firstName, _lastName, null), Throws.InstanceOf<ContractException>());
        }
