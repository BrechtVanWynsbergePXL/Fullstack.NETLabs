...
namespace DevOps.Api.Tests
{
    public class TeamsControllerTests : TestBase
    {
        ...
        public void Setup()
        {
            ...
            _controller = new TeamsController(_teamServiceMock.Object, _teamRepositoryMock.Object, _mapperMock.Object);
        }
        ...
        public void GetAll_ShouldUseRepositoryAndMapResult()
        {
            ...
            _teamRepositoryMock.Setup(repo => repo.GetAllAsync()).ReturnsAsync(allTeams);
            ...
            var models = result.Value as IEnumerable<TeamDetailModel>;
