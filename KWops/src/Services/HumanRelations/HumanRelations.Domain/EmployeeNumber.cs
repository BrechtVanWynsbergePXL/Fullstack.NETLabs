...
namespace HumanRelations.Domain
{
    public class EmployeeNumber : ValueObject<EmployeeNumber>
    {
        ...
        {
            Contracts.Require(!string.IsNullOrEmpty(value), "An employee nubmer cannot be empty");
            ...
            Contracts.Require(Month >= 1 && Month <= 12, "Digits 5 and 6 of an employee number must be a valid day");
